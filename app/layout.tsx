...
title: 'rambudev | Senior WordPress Development',
  ...
  generator: 'v0.app',
  metadataBase: new URL('https://wp.rambu.dev'),
  openGraph: {
...
const jsonLd = { '@context': 'https://schema.org', '@type': 'ProfessionalService', name: 'rambudev', url: 'https://wp.rambu.dev', description: 'Senior WordPress development, custom plugins, themes, maintenance, and troubleshooting.', email: 'vn.nqhung@gmail.com', areaServed: 'Worldwide', priceRange: '$$' }
